      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            ...
            {/* Create List Button */}
            <button
              onClick={() => setCurrentPage('create-list')}
              className={`flex items-center space-x-2 px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors text-sm font-medium ${updating || creatingList ? 'opacity-50 cursor-not-allowed' : ''}`}
              disabled={updating || creatingList}
            >
