        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="flex justify-center space-x-4 pt-6">
            <button
              type="button"
              onClick={onBack}
              className={`px-6 py-3 bg-gray-50 text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-100 transition-colors ${updating ? 'opacity-50 cursor-not-allowed' : ''}`}
              disabled={updating}
            >
              Cancel
            </button>
